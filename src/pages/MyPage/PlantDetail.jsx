...
export default function PlantDetail({ onBack }) {
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: '#F5F5F4', overflow: 'hidden' }}>
            <div style={{ width: 430, height: 646, left: 0, top: 286, position: 'absolute', background: 'white', borderTopLeftRadius: 15, borderTopRightRadius: 15, borderTop: '1px #E7E5E4 solid' }} />
            <img style={{ width: 200, height: 200, left: 115, top: 162, position: 'absolute', borderRadius: 200, outline: '1px #E7E5E4 solid' }} src="https://placehold.co/200x200" />
            <div style={{ paddingLeft: 15, paddingRight: 15, paddingTop: 10, paddingBottom: 10, left: 174, top: 382, position: 'absolute', background: '#E8F5E0', borderRadius: 20, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
                <div style={{ color: '#1A3D2B', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', lineHeight: 20, wordWrap: 'break-word' }}>몬스테라</div>
            </div>
            <div style={{ paddingLeft: 15, paddingRight: 15, paddingTop: 10, paddingBottom: 10, left: 347, top: 124, position: 'absolute', background: '#D9D9D9', borderRadius: 20, outline: '1px #E7E5E4 solid', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
                <div style={{ color: '#2F2F2F', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', lineHeight: 20, wordWrap: 'break-word' }}>편집</div>
            </div>
            <div style={{ width: 350, left: 40, top: 446, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'inline-flex' }}>
            ...
            <div style={{ width: 430, height: 120, left: 0, top: 812, position: 'absolute', background: 'white', overflow: 'hidden' }}>
                <div style={{ width: 390, height: 50, paddingLeft: 45, paddingRight: 45, paddingTop: 10, paddingBottom: 10, left: 20, top: 22, position: 'absolute', background: '#6AB43A', borderRadius: 10, justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex' }}>
                    <div style={{ color: 'var(--design-background-white, #F7F6F2)', fontSize: 16, fontFamily: 'Pretendard', fontWeight: '700', wordWrap: 'break-word' }}>진단 받기</div>
                </div>
            </div>
            <div style={{ width: 126, height: 37, left: 152, top: 11, position: 'absolute', background: 'black', borderRadius: 19 }} />
        </div>
    );
}