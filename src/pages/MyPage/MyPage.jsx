            ...
            <div className="mypage-content">
                ...
                <section className="card section-card">
                    <div className="section-header">
                        ...
                        <button className="chevron-btn" aria-label="더보기">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.28957 15.88L13.1696 12L9.28957 8.11998C8.89957 7.72998 8.89957 7.09998 9.28957 6.70998C9.67957 6.31998 10.3096 6.31998 10.6996 6.70998L15.2896 11.3C15.6796 11.69 15.6796 12.32 15.2896 12.71L10.6996 17.3C10.3096 17.69 9.67957 17.69 9.28957 17.3C8.90957 16.91 8.89957 16.27 9.28957 15.88Z" fill="black" />
                            </svg>
