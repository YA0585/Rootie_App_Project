...
const IconLocation = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="#6AB43A" stroke="#6AB43A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

const IconStar = () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2L9.19 8.63L2 9.24L7.46 13.97L5.82 21L12 17.27Z" fill="#6AB43A" />
    </svg>
);
                ...
                <div className={styles.aiBanner}>
                    <div className={styles.aiIconWrap}>
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none">
                            <path
                                d="M31 7L38.5 19.5L31 32L23.5 19.5L31 7Z"
                                fill="#6AB43A"
                            />
                            <path
                                d="M16 23.5L23.5 36L16 48.5L8.5 36L16 23.5Z"
                                fill="#6AB43A"
                            />
                        </svg>
                    </div>
