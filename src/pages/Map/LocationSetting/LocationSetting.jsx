...
const LocationSetting = ({ onBack, onConfirm, navBar }) => {
        ...
        <div className="loc-root">
            ...
            <div className="loc-map-area">
                ...
                <div className="loc-map-svg-placeholder" style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#e8e0d0" }}>
                    <img src={MapImage} alt="Map placeholder" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            ...
            <div className="loc-result">
                ...
                <button className="loc-confirm-btn" onClick={onConfirm || onBack}>확인</button>
            </div>
